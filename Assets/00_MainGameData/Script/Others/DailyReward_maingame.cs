...
using System;
    ...
    public class DailyReward_maingame : MonoBehaviour
    {
        public static DailyReward_maingame Instance { get; private set; }
        ...
        private const string NextRewardTimePPK = "DAILY_REWARD_TIME_MAINGAME";
